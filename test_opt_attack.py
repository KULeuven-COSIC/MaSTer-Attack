...
if __name__ == '__main__':
    ...
    for precision in fixed_point_precisions:
        for model_name, model_path, dataset_name in models_info:
            ...
            for target_label in label_range:
                ...
                attack_rate[key] = AttackRunner.run_attack_on_all_models([model_name, model_path, dataset_name], target_label, return_all_outputs=False, attack_type=attack_type, attack_reference=reference_matrices[ref_key], fixed_point = precision, optimised=optimised, budget=budget, realistic=True)
    ...
    Visualise.plot_success_rate_by_labels_and_datasets(success_rates, save_dir='label_plots/budget/opt_attack')
    Visualise.plot_success_rate_by_models(success_rates, save_dir="model_plots/budget/opt_attack")